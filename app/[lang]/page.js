  ...
  return (
    <div>
      ...
      <div className="bg-white">
        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mt-12">
              <Link href="/products">
                <button className="bg-logolight-900 hover:bg-logo text-white px-8 py-3 rounded-lg font-semibold transition-colors flex items-center gap-2 mx-auto duration-130 hover:-translate-y-0.5 cursor-pointer">
        ...
        <section className="py-16 px-4 bg-logolight-100">
          <div className="max-w-6xl mx-auto">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={index} className="flex items-center gap-4">
                      <i className="fa fa-check-square-o fa-2x w-6 h-6 text-logolight-700 flex-shrink-0" />
                      <span className="text-logolight-700 ">{item.text}</span>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <h3 className="font-semibold text-logo mb-2">{t('shipping_services_section.services.worldwide_shipping.title')}</h3>
                <p className="text-sm text-logolight-700">{t('shipping_services_section.services.worldwide_shipping.description')}</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-logo mb-2">{t('shipping_services_section.services.secure_packaging.title')}</h3>
                <p className="text-sm text-logolight-700">{t('shipping_services_section.services.secure_packaging.description')}</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-logo mb-2">{t('shipping_services_section.services.tracking.title')}</h3>
                <p className="text-sm text-logolight-700">{t('shipping_services_section.services.tracking.description')}</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-logo mb-2">{t('shipping_services_section.services.customer_support.title')}</h3>
                <p className="text-sm text-logolight-700">{t('shipping_services_section.services.customer_support.description')}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/products">
                <button className="bg-logolight-900 hover:bg-logo text-white px-8 py-4 rounded-lg font-semibold text-lg transition-colors duration-130 hover:-translate-y-0.5 cursor-pointer">
                  {t('call_to_action_section.browse_button')}
                </button>
              </Link>
              <Link href="/contact">
                <button className="border-2 border-logolight-400 hover:border-logolight-600 text-logolight-800 px-8 py-4 rounded-lg font-semibold text-lg transition-colors duration-130 hover:-translate-y-0.5 cursor-pointer">
