    ...
    <footer className="w-full p-4 bg-logolight-700 text-white mt-8">
      <div className="flex flex-col md:flex-row justify-between mb-8 gap-8">
        ...
        <div className="flex-1 p-6 flex items-center flex-col">
          ...
          <hr className="mb-2 w-1/3" />
          <p className="text-sm">Mahmudiye, Karaağaç Cd. No:10</p>
          <p className="mb-2 text-sm">İnegöl/Bursa 16400</p>
          <p className="mb-1">
        ...
        <div className="flex-1 p-6 flex items-center flex-col">
          ...
          <ul className="text-center">
            ...
            <li className="mb-1 text-sm"><Link href="/catalogs" className="hover:underline">{t('quick_links.catalogs')}</Link></li>
            <li className="mb-1 text-sm"><Link href="/bayilik" className="hover:underline">{t('quick_links.bayilikler')}</Link></li>
