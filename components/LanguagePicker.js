...
export default function LanguagePicker() {
    ...
    const handleLanguageChange = (newLocale) => {
        ...
        // Use router.replace to navigate to the same path but with new locale
        // pathname will be something like '/products' (without locale)
    ...
    return (
        <div ref={pickerRef} className="relative inline-block">
            ...
            <div
                className={`absolute left-0 bottom-full mb-2 w-40 bg-white border rounded shadow transition-all duration-200 ${
                ...
                {LANGUAGES.map(lang => (
                    <button
                        ...
                        className={`flex items-center gap-2 w-full px-3 py-2 hover:bg-gray-100 text-left ${
                            lang.code === currentLang ? 'bg-gray-50' : ''
                        }`}
